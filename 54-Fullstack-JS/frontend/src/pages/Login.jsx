            ...
            <div className='mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white'>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="my-5">
                        ...
                        <input className="border w-full p-3 mt-3 bg-gray-100 rounded-xl" placeholder="Tu Password" type="password" value={password} onChange={e => setPassword(e.target.value)}/>
                    </div>
